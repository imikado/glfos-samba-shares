...
impl AddRemoteShareDialog {
    pub fn new() -> Self {
        ...
        mount_point_entry.set_text("/media/");
        ...
        advanced_group.set_description(Some(&gettext(
            "These options will be automatically included in the configuration"
        )));
        ...
        let info_banner = adw::Banner::new(&gettext(
            "The new share will be added to your NixOS configuration. Run 'sudo nixos-rebuild switch' to apply changes."
        ));
